...
import jp.annict.lib.interfaces.services.me.MeFollowingActivitiesGetRequestQuery
import jp.annict.lib.interfaces.services.me.MeFollowingActivitiesGetResponseData
import jp.annict.lib.interfaces.services.me.MeFollowingActivitiesService
...
data class MeFollowingActivitiesGetRequestQueryImpl (
...
data class MeFollowingActivitiesGetResponseDataImpl (
    val activities: Array<Activity>?,
    val total_count: Long?,
    val next_page: Long?,
    val prev_page: Long?
) : MeFollowingActivitiesGetResponseData {

    constructor() : this(null, null, null, null)

    override fun toDataClass(response: Response): MeFollowingActivitiesGetResponseData {
        response.apply {
            JsonUtil.JSON_PARSER.parse(body?.string()).asJsonObject.apply { return MeFollowingActivitiesGetResponseDataImpl (
...
class MeFollowingActivitiesServiceImpl(val client: IAnnictClient) : MeFollowingActivitiesService {

    override fun get(query: MeFollowingActivitiesGetRequestQuery) : MeFollowingActivitiesGetResponseData {
        this.client.apply { return MeFollowingActivitiesGetResponseDataImpl().toDataClass(request(Request.Builder().url(query.url(getUrlBuilder())))) }
    }
